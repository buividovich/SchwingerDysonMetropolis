...
int      prod_mc_steps            = 10000000; //Number of MC steps for production runs
int      therm_mc_steps           = 0;       //Number of MC steps for thermalization
int      mc_interval              = 20;      //Interval between the successive presumably uncorrelated measurements
