...
int      prod_mc_steps            = 100000;  //Number of MC steps for production runs
...
int      mc_reporting_interval    = 20000;   //The interval at which the current state of the MC process is reported
